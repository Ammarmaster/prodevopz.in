...
export const metadata: Metadata = {
  title: "Saad Mulla — CEO at ProDevOpz | Leadership",
  description:
    ...
    "@graph": [
      {
        ...
        "url": "https://prodevopz.jobsio.in/leadership/saad-mulla",
        "name": "Saad Mulla — CEO at ProDevOpz | Leadership",
        "isPartOf": {
          "@type": "WebSite",
      ...
      },
      {
        ...
        "url": "https://prodevopz.jobsio.in/leadership/saad-mulla",
        "alumniOf": "Rani Channamma University (RCUB)",
        "address": {
          "@type": "PostalAddress",
    ...
    <div className="max-w-5xl mx-auto px-4 md:px-8 py-16 flex flex-col gap-12 text-left">
      ...
      <section className="glass-panel border-white/[0.06] p-8 md:p-10 flex flex-col gap-6">
        ...
        <div className="flex flex-col gap-4 text-xs sm:text-sm text-foreground/70 leading-relaxed">
          <p>
            Saad Mulla serves as the Chief Executive Officer (CEO) of ProDevOpz. In this role, he steers the company&apos;s overarching commercial trajectory, strategic market positioning, organizational culture, and client relations.
          </p>
          <p>
            Based in Dodda Ballapur, Karnataka, and educated at Rani Channamma University (RCUB), Saad brings an energetic, results-focused approach to executive management. He works closely with co-founders and technical directors to guarantee seamless execution across custom software products, enterprise ERP deployments, and digital transformation initiatives.
          </p>
        </div>
      </section>
